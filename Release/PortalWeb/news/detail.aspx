<%@ page title="" language="C#" masterpagefile="~/MasterPage/InfoList.master" autoeventwireup="true" inherits="news_detail, PageCode" enableviewstate="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderContent" runat="Server">
	...
	<!--左侧标题 end-->
	<div class="wei_ri">
		<a href="../index.aspx">首页</a> > <span class="we_te"><a href="index.aspx">价格预警</a></span>
	</div>
	<div class="clear">
	</div>
	<div class="zbody_b">
