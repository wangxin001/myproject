<%@ page title="" language="C#" masterpagefile="~/MasterPage/InfoList.master" autoeventwireup="true" inherits="job_index, PageCode" enableviewstate="false" %>
                ...
                <ul>
                    <asp:Repeater ID="rpInfo" runat="server">
                        <ItemTemplate>
                            ...
                            <%# (Container.ItemIndex > 0 && (Container.ItemIndex + 1) % 5 == 0 && Container.ItemIndex != (this.AspNetPager.PageSize-1) ) ? "</ul><ul>" : string.Empty%>
                        </ItemTemplate>
                    </asp:Repeater>
                </ul>
            </div>
