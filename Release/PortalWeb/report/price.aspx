<%@ page title="" language="C#" masterpagefile="~/report/MasterPage.master" autoeventwireup="true" inherits="report_price, PageCode" enableviewstate="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderContent" runat="Server">
    ...
    <div class="zbody_b">
        ...
        <div class="zb_le">
            <span class="menu">
                <ul>
                    <li class="me_on"><a href="./price.aspx">菜价查询</a> </li>
                    <li class="me_off"><a href="./Infor1a.aspx">个人资料</a> </li>
                </ul>
            </span>
            <div class="clear">
            </div>
