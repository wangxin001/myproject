<%@ page title="" language="C#" masterpagefile="~/MasterPage/AdminPage.master" autoeventwireup="true" inherits="Price_VPIPrice, PageCode" theme="_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function btnInput_onclick()
        {
            ...
            document.getElementById("dialogContent").src = "./VPIInput.aspx?PriceDate=" + curDate;

            $("#dialog").dialog({ title: '录入价格指数 ' + curDate, resizable: false, width: 550, height: 300, modal: true });
            $('#dialog').dialog('open');
        }
