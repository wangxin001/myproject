<%@ page title="" language="C#" masterpagefile="~/MasterPage/AdminPage.master" autoeventwireup="true" inherits="InfoPub_QAList, PageCode" theme="_Default" %>
...
<!--
		...
		{
			location.href = "QAEdit.aspx?BoardID=<%=strBoardID %>";
		}
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
	...
	<div class="divToolBar">
		<input id="btnAdd" type="button" value="添加内容" onclick="return btnAdd_onclick()" />
	</div>
	<asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound"
		...
		<Columns>
			...
			<asp:BoundField HeaderText="显示顺序" DataField="TopicOrder" HeaderStyle-CssClass="Width-75" />
			<asp:BoundField HeaderText="发布日期" DataField="PublishDate" DataFormatString="{0:yyyy-MM-dd}"
				HeaderStyle-CssClass="Width-80" />
			<asp:BoundField HeaderText="创建者" DataField="UserName" HeaderStyle-CssClass="Width-60" />
			<asp:BoundField HeaderText="创建时间" DataField="Created" DataFormatString="{0:yyyy-MM-dd HH:mm}"
				HeaderStyle-CssClass="Width-80" />
