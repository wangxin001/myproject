<%@ page title="" language="C#" masterpagefile="~/MasterPage/AdminPage.master" autoeventwireup="true" inherits="InfoPub_PictureList, PageCode" theme="_Default" %>
...
<!--
		...
		function btnAdd_onclick()
		{
			...
			location.href = "PictureEdit.aspx?BoardID=<%=strBoardID %>";
		}
	...
	<asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound"
		...
		<Columns>
			...
			<asp:HyperLinkField HeaderText="标题" DataTextField="TopicTitle" DataNavigateUrlFields="TopicID"
				DataNavigateUrlFormatString="./PictureView.aspx?InfoID={0}" Target="_blank" ItemStyle-CssClass="ItemLeft" />
