<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XiaoMaiInput.aspx.cs" Inherits="Price_XiaoMaiInput" %>
    ...
    <div>
        <table class="TableInfo" cellpadding="2" cellspacing="1">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtPriceIndex" runat="server" CssClass="TextBorder"></asp:TextBox>
                </td>
            </tr>
			<tr>
                <td>
