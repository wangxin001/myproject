...
public partial class Price_DaDouInput : System.Web.UI.Page
{
    ...
    protected void LoadPriceDate()
    {
        ...
        strSQL += " AND ItemType = " + ((int)model.PriceType.Index_DaDou).ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        if (!String.IsNullOrEmpty(this.txtPriceIndexID.Text))
        {
            ...
            Log.info("更新了 " + strPriceDate + " 大豆价格指数：" + record.ToString(true));
        }
        else
        {
            ...
            record.ItemID = 0;
            record.ItemName = "";
            record.ItemType = (int)model.PriceType.Index_DaDou;
            record.ItemUnit = "";
            record.Price01 = 0.0M;
            record.Price02 = Convert.ToDecimal(this.txtPriceIndex.Text);
            record.Price03 = 0.0M;
            ...
            Log.info("添加了 " + strPriceDate + " 大豆价格指数：" + record.ToString(true));
        }
