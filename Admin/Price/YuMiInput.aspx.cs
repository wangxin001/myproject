...
public partial class Price_YuMiInput : System.Web.UI.Page
{
    ...
    protected void LoadPriceDate()
    {
        ...
        strSQL += " AND ItemType = " + ((int)model.PriceType.Index_YuMi).ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        if (!String.IsNullOrEmpty(this.txtPriceIndexID.Text))
        {
            ...
            Log.info("更新了 " + strPriceDate + " 玉米价格指数：" + record.ToString(true));
        }
        else
        {
            ...
            record.ItemID = 0;
            record.ItemName = "";
            record.ItemType = (int)model.PriceType.Index_YuMi;
            record.ItemUnit = "";
            record.Price01 = 0.0M;
            record.Price02 = Convert.ToDecimal(this.txtPriceIndex.Text);
            record.Price03 = 0.0M;
            ...
            Log.info("添加了 " + strPriceDate + " 玉米价格指数：" + record.ToString(true));
        }
