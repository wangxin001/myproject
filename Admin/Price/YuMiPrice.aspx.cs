...
public partial class Price_YuMiPrice : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        MasterPage_AdminPage master = (MasterPage_AdminPage)this.Master;
        master.PageTitle = "玉米价格指数录入";
    ...
    protected void LoadPriceIndex()
    {
        ...
        strSQL += " From PriceRecord WHERE ItemType = " + ((int)model.PriceType.Index_YuMi).ToString();
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Del")
        {
            ...
            Log.info("删除玉米价格指数：" + price.ToString(true));
