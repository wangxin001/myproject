<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminPage.master" AutoEventWireup="true" CodeFile="YuMiPrice.aspx.cs" Inherits="Price_YuMiPrice" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function InputPriceIndex(v) {
            document.getElementById("dialogContent").src = "./YuMiInput.aspx?PriceDate=" + v;

            $("#dialog").dialog({ title: '录入玉米价格指数 ' + v, resizable: false, width: 350, height: 190, modal: true });
            $('#dialog').dialog('open');
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound"
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="玉米价格指数" DataField="Price02" HeaderStyle-CssClass="Width-150" />
