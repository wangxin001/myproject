...
public partial class Price_DaDouPrice : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        MasterPage_AdminPage master = (MasterPage_AdminPage)this.Master;
        master.PageTitle = "大豆价格指数录入";
    ...
    protected void LoadPriceIndex()
    {
        ...
        strSQL += " From PriceRecord WHERE ItemType = " + ((int)model.PriceType.Index_DaDou).ToString();
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Del")
        {
            ...
            Log.info("删除大豆价格指数：" + price.ToString(true));
