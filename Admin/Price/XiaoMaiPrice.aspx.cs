...
public partial class Price_XiaoMaiPrice : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        MasterPage_AdminPage master = (MasterPage_AdminPage)this.Master;
        master.PageTitle = "小麦价格指数录入";
    ...
    {
        // 获取完整的数据记录，所有点数都显示出来
        String strSQL = " Select PriceID,PriceDate,ISNULL(Price02,0.0) Price02,ISNULL(Price04,0.0) Price04 ";
        strSQL += " From PriceRecord WHERE ItemType = " + ((int)model.PriceType.Index_XiaoMai).ToString();
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Del")
        {
            ...
            Log.info("删除小麦价格指数：" + price.ToString(true));
