...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        /**
         * 对上传文件的保存文件夹做处理，上传的文件以年月日分类文件夹进行存储。
         * 此处处理文件夹信息，后续页面进行文件名的处理，使其能已GUID的文件名形式进行保存
         * 
         * 2010-12-10  张洲峰
         */
        String strFolder = DateTime.Now.ToString("yyyy/MMdd/");
        
        type = ResourceType.Add("Images");
        type.Url = BaseUrl + "images/" + strFolder;
        type.Dir = BaseDir == "" ? "" : BaseDir + "images/" + strFolder;
        type.MaxSize = 0;
