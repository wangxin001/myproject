...
public partial class InfoPub_QAList : System.Web.UI.Page
{
    ...
    protected void LoadTopicList()
    {
        ...
        List<model.InfoTopicInfo> topics = OR.Control.DAL.GetModelList<model.InfoTopicInfo>("BoardID=" + strBoardID + " Order By TopicOrder, Created", this.AspNetPager.CurrentPageIndex - 1, ref _RowCount);
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            hyMod.NavigateUrl = "./QAEdit.aspx?BoardID=" + strBoardID + "&TopicID=" + topic.TopicID.ToString();
