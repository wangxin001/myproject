...
public partial class InfoPub_TopicList : System.Web.UI.Page
{
    ...
    protected void LoadTopicList()
    {
        ...
        List<model.InfoTopicInfo> topics = OR.Control.DAL.GetModelList<model.InfoTopicInfo>("BoardID=" + strBoardID + " Order By Created Desc", this.AspNetPager.CurrentPageIndex - 1, ref _RowCount);
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            hyMod.NavigateUrl = "./TopicEdit.aspx?BoardID=" + strBoardID + "&TopicID=" + topic.TopicID.ToString();

            if (!topic.ShowDate)
            {
                e.Row.Cells[4].Font.Strikeout = true;
            }
